...
DATA = Path("examples/real_validation_v7_external_attack.jsonl")
OUT = Path("results/real_validation_v7_external_attack_results.jsonl")
...
print("=" * 60)
print("VALIDATION V7 EXTERNAL ATTACK — FLAN-T5-LARGE")
print("=" * 60)
