...
INPUT = Path("results/real_validation_v7_external_attack_results.jsonl")
OUTPUT = Path("results/real_validation_v9_external_attack_omnia.jsonl")
MD = Path("docs/REAL_VALIDATION_V9_EXTERNAL_ATTACK.md")
...
def completeness_violation(row):
    ...
    if token_set(out) and token_set(out) < token_set(exp):
        return True
...
md = []
md.append("# V9 — External Attack Dataset")
md.append("")
md.append("## Results")
...
print("=" * 60)
print("OMNIA V9 — EXTERNAL ATTACK")
print("=" * 60)
print("Counts:", counts)
