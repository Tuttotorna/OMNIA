...
OUTPUT = Path("results/baseline_majority_v2_harder.jsonl")
MD = Path("docs/BASELINE_MAJORITY_V2_HARDER.md")
...
with open(INPUT, encoding="utf-8") as f:
    for line in f:
        ...
        r["baseline_majority_v2_harder"] = {"gate_status": gate}
        rows.append(r)
        counts[gate] += 1
...
for r in rows:
    ...
    flagged = r["baseline_majority_v2_harder"]["gate_status"] != "GO"
...
md = []
md.append("# Baseline Majority V2 — Harder Dataset")
md.append("")
md.append("## Results")
...
md.append("")
md.append("## Status")
md.append("Same heuristic as V2. No tuning.")
MD.write_text("\n".join(md), encoding="utf-8")

print("=" * 60)
print("BASELINE V2 HARDER")
print("=" * 60)
print("Counts:", counts)
