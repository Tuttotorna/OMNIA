"""
Analyze OMNIA support-response mini-result.
...
INPUT_PATH = Path("examples/support_response_results.jsonl")
...
def main() -> None:
    ...
    print("-" * 40)
    print("OMNIA ANALYSIS REPORT: SUPPORT RESPONSE")
    print("-" * 40)
    ...
    print("\ncanonical_formula:")
    print("support-readable output != always structurally admissible")
    print("-" * 40)
